function renderMainBlocks() {
  document.body.innerHTML = `
    ...
    <div class="buttons" id="buttons">
      <div class="buttons__button" id="restart">Начать заново</div>
      <div class="buttons__button" id="save">Сохранить</div>
      <div class="buttons__button" id="disableSound">Звук вкл/выкл</div>
      <div class="buttons__button" id="statistics">Статистика</div>
    </div>
    </div>
